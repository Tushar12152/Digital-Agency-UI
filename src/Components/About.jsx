            ...
            <Title Heading={'About Us'}></Title>
             ...
             <div className="flex justify-between mt-40 gap-6">
                   <div className="w-[50%]">
                        ...
                        <button className="px-5 rounded-2xl text-white hover:bg-yellow-400 py-3 bg-blue-500">Our Services</button>
                   </div>

                   <div className="w-[50%]">
                        <div className="flex gap-6">
                              <div>
                                    <div className="bg-gray-400 p-20 text-center mt-10">
                                        <h1 className="text-red-600 font-bold text-2xl">210+</h1>
                                        <p className="">Satisfied Customers</p>
                                    </div>

                                    <div className="bg-gray-400 p-20 mt-10 text-center">
                                        <h1 className="text-red-600 font-bold text-2xl">210+</h1>
                                        <p className="">Satisfied Customers</p>
                                    </div>
                              ...
                              <div>
                                    <div className="bg-gray-400 p-20 text-center">
                                        <h1 className="text-red-600 font-bold text-2xl">210+</h1>
                                        <p className="">Satisfied Customers</p>
                                    </div>
